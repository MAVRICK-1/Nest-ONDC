  ...
  return data && data.productData ? (
    <MyContext.Provider value={value}>
      ...
      <Routes>
        ...
        <Route exact path="/seller" element={<SellerForm />} />
        <Route exact path="/product/:id" element={<DetailsPage data={data.productData} />} />
        <Route exact path="/cart" element={<Cart />} />
        <Route exact path="/wishlist" element={<Wishlist />} />
        <Route exact path="/terms" element={<Terms />} />

        {isLogin === null && <Route exact path="/signIn" element={<SignIn />} />}
        {isLogin === null && <Route exact path="/signUp" element={<SignUp />} />}
        {isLogin === null && <Route exact path="/forgotPassword" element={<ForgotPassword />} />}

        <Route exact path="/map" element={<MapComponent data={data} />} />
